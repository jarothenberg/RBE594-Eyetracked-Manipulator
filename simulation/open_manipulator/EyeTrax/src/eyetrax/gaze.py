...
def _create_face_mesh():
    try:
        ...
        raise ImportError(
            "Failed to import mediapipe tasks face landmarker."
        ) from e

    model_path = '/root/ros2_ws/src/open_manipulator/EyeTrax/models/face_landmarker.task'
    # model_path = './simulation/open_manipulator/EyeTrax/models/face_landmarker.task'
...
class GazeEstimator:
    ...
    def extract_features(self, image):
        ...
        """
        from mediapipe.tasks.python.vision import FaceLandmarkerResult  # type: ignore
